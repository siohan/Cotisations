...
$lang['friendlyname'] = 'T2T Cotisations';
$lang['resultsfoundtext'] = 'Résultats trouvés';
$lang['moddescription'] = 'Gérez facilement les cotisations de vos adhérents.';
$lang['welcome_text'] = '<p>Bienvenue dans le module de gestion des cotisations de vos adhérents</p>';
...
<p>Ce module vous permet de gérer les cotisations de votre club</p>
<li>L\'auteur peut aussi être contacté via skype sous le pseudo agiwebconseil.</li>
<li>Enfin, vous pouvez aussi m\'envoyer un mail(voir ci-dessous).</li>  
</ul>
