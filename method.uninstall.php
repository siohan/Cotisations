...
$sqlarray = $dict->DropTableSQL( cms_db_prefix()."module_cotisations_types_cotisations" );
$dict->ExecuteSQLArray($sqlarray);


$dict = NewDataDictionary( $db );
$sqlarray = $dict->DropTableSQL( cms_db_prefix()."module_cotisations_belongs" );
$dict->ExecuteSQLArray($sqlarray);
...
$this->RemovePermission('Cotisations use');
